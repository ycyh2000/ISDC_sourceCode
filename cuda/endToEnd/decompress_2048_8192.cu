...
//        uint8_t packedExpw = (expMemory >> 24) & 0xFF;
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PROCESS SIGN ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PROCESS SIGN ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//        uint8_t* sign_data_u32 = reinterpret_cast<uint8_t*>(sign_data);
//        uint8_t signMemory = sign_data_u32[
//            (bid * (K_GLOBAL_SPARSE / 4) + i * 32 / 2 + tid / 2)
//        ];
...
//        if(bid == N_GLOBAL - 1){
//            printf("tid = %d, x = (%u,%u,%u), y = (%u,%u,%u), z = (%u,%u,%u), w = (%u,%u,%u),\n",tid, packedSignx,packedExpx,packedDatax, packedSigny,packedExpy,packedDatay, packedSignz,packedExpz,packedDataz, packedSignw,packedExpw,packedDataw);
//        }

//        (decompressed_weight_gpu)[(K_GLOBAL * bid * PROCESSLINE + dataDecompressedRound * 32 * GROUPNUM * M + tid * M) + packedIndexx] = packedDatax;
//        (decompressed_weight_gpu)[(K_GLOBAL * bid * PROCESSLINE + dataDecompressedRound * 32 * GROUPNUM * M + tid * M) + packedIndexy] = packedDatay;
//        (decompressed_weight_gpu)[(K_GLOBAL * bid * PROCESSLINE + dataDecompressedRound * 32 * GROUPNUM * M + tid * M) + packedIndexz] = packedDataz;
//        (decompressed_weight_gpu)[(K_GLOBAL * bid * PROCESSLINE + dataDecompressedRound * 32 * GROUPNUM * M + tid * M) + packedIndexw] = packedDataw;
...
//    for(int i = 0; i < compressed_data_width_size; i++){
//        printf("d_compressed_data_width[%d] = %u\n", i, compressed_data_width[i]);
//    }
...
//    printf("start\n");
//    size_t start_elements = (1 - 1) * K_GLOBAL;
//    size_t total_elements = (1) * K_GLOBAL;
